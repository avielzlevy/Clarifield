...
const Reports = ({ reports, loadingReports }) => {
  ...
  // Use plural keys first; if undefined, fall back to singular keys
  const formatsData = reports.formats || reports.format || {};
  const definitionsData = reports.definitions || reports.definition || {};

  const tabs = [
    { label: "formats", data: formatsData },
    { label: "definitions", data: definitionsData },
  ];
